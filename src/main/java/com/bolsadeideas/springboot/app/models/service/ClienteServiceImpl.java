...
import com.bolsadeideas.springboot.app.models.dao.IClientePageableDao;
...
public class ClienteServiceImpl implements IClienteService {
	...
	@Autowired
	private IClientePageableDao clientePageableDao;
	...
	public Cliente fetchByIdWithFacturas(Long id) {
		return clientePageableDao.fetchByIdWithFacturas(id);
	}
